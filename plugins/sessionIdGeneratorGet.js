var o,
  ...
  n = function (e, t) {
    ...
    for (l = 0; l < i; l++)
      for (var s = 0; s < n; s++)
        (r[s + l] += parseInt(a[s], 10) * parseInt(o[l], 10)),
          (r[s + 1 + l] += Math.floor(r[s + l] / 10)),
          (r[s + l] = r[s + l] % 10)
  ...
  i = function (e, t) {
    for (
      ...
      (l = d < r ? parseInt(a[d], 10) : 0),
        (c = d < n ? parseInt(o[d], 10) : 0),
        (s = Math.round(l) + Math.round(c) + i),
        (a[d] = '' + (s % 10)),
        (i = s >= 10 ? 1 : 0)
